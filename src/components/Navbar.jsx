    ...
    <nav className="w-full fixed top-0 left-0 right-0 z-50 backdrop-blur-sm bg-black/30 border-b border-zinc-800">
      <div className="max-w-6xl mx-auto h-16 flex items-center justify-between px-4">
        ...
        <div className="flex items-center space-x-3">
          {authState ? (
            <>
              <Link to={`/dashboard/${user.batch}`}>
                <button className="flex items-center gap-1 cursor-pointer bg-zinc-900 px-5 xl:py-2 py-2 rounded-lg hover:bg-zinc-950 transition-all duration-300 border border-zinc-800">
